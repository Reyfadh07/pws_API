...
import ws.a.tokobuku.exceptions.NonexistentEntityException;
import ws.a.tokobuku.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.a_tokobuku_jar_0.0.1-SNAPSHOTPU");
